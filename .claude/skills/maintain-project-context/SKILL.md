...
The canonical references live in `.codex/skills/maintain-project-context/references/` and are shared with the Codex skill. Do not fork them.

## Start every project task

1. Read [PROJECT_CONTEXT.md](../../../.codex/skills/maintain-project-context/references/PROJECT_CONTEXT.md) completely.
2. Read [ADR_LOG.md](../../../.codex/skills/maintain-project-context/references/ADR_LOG.md) completely.
